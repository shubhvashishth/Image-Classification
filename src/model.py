...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        #modifying because the input image is 1 channel(i.e grayscale)
        ...
        #also modifiying the output channel to 2 since it's a binary classification
...
def test():
    net = ResNet18()
    #again modifying this to 1 because its a binary classification
